...
public class ISOParser: StringToDateTransformable {
    ...
    public init?(_ src: String, options: ISOParser.Options? = nil) {
        ...
        now_cmps = self.options.calendar.dateComponents([.year, .month, .day], from: Date())
    ...
    private func parse_digits_3(_: Int, _ segment: inout Int) throws {
    ...
    private func parse_digits_7(_: Int, _ segment: inout Int) throws {
    ...
    private func parse_digits_2(_ num_digits: Int, _ segment: inout Int) throws {
        func parse_hyphens_3(_: Int, _ segment: inout Int) throws {
            date.year = now_cmps.year!
            date.month_or_week = now_cmps.month!
            date.day = segment
        }

        func parse_hyphens_2(_: Int, _ segment: inout Int) throws {
            date.year = now_cmps.year!
        ...
        func parse_hyphens_0(_: Int, _ segment: inout Int) throws {
            if current() == "-" {
                // Implicit century
                date.year = now_cmps.year!
    ...
    private func parse_digits_5(_: Int, _ segment: inout Int) throws {
        guard hyphens == 0 else { throw ISO8601ParserError.invalid }
        // YYDDD
        date.year = now_cmps.year!
        date.year -= (date.year % 100)
    ...
    private func parse_digits_4(_ num_digits: Int, _ segment: inout Int) throws {
        ...
        func parse_hyphens_1(_: Int, _ segment: inout Int) throws {
    ...
    private func parse_digits_6(_: Int, _ segment: inout Int) throws {
    ...
    private func parse_digits_8(_: Int, _ segment: inout Int) throws {
        // YYYY MM DD
        guard hyphens == 0 else {
            throw ISO8601ParserError.invalid
        }
    ...
    private func parse_digits_0(_: Int, _: inout Int) throws {
