...
public class DOTNETParser: StringToDateTransformable {
    ...
    public static func parse(_ string: String, region: Region, options _: Any?) -> DateInRegion? {
...
public class DOTNETFormatter: DateToStringTrasformable {
    public static func format(_ date: DateRepresentable, options _: Any?) -> String {
